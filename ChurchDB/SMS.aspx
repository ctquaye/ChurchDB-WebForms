<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMS.aspx.cs" Inherits="ChurchDB.SMS" %>
...
<head runat="server">
  ...
  <div class="content-wrapper">
    ...
    ProviderName="System.Data.SqlClient" 
            SelectCommand="Select id, firstname,surname FROM memberTable;">                
             ...
             <div class="form-group container">            
                <label for="department">Contacts</label>
                  <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-check-square" aria-hidden="true" style="margin-right:4px;"></i></span>

                       <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table "></i>Contacts Table</div>
        <div class="card-body"style="height:500px; overflow:auto">
<asp:Panel ID="Panel1" runat="server">
                <asp:GridView ID="gvContacts" DataSourceID="dsContacts" AutoGenerateColumns="false"
                    BackColor="#ccffff" CssClass="table table-responsive table-striped" DataKeyNames="id" runat="server">
                   <Columns>                  
          ...
          <div class="form-group">
            <div class="form-row">
             ...
             <div class="form-group">            
                <label for="department">Recipients</label>
                  <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-check-square" aria-hidden="true" style="margin-right:4px;"></i></span>
              <asp:GridView ID="gvRecipient" runat="server"></asp:GridView>
              </div>
                  </div>   
            ...
            <div class="form-row">
             ...
             <div class="form-group">            
                <label for="department">Message</label>
                  <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-envelope" aria-hidden="true" style="margin-right:4px;"></i></span>
             <textarea id="smsField" cols="50" rows="10"></textarea>
              </div>
                  </div>
                          

          <asp:Button runat="server" text="Send" ID="sendBtn" class="btn btn-primary btn-block"></asp:Button>
                    </div>
              </div>
                </div>
                    </div>
