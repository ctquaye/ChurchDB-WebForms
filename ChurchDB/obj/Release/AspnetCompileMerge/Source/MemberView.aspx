...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    ProviderName="System.Data.SqlClient" 
            SelectCommand="Select id, firstname,surname,gender,dob,marital_status,telephone,residence,profession,department,join_date FROM memberTable;"
            UpdateCommand="UPDATE [memberTable] SET firstname=@fname, surname=sname, gender=@sex, dob=@dob, marital_status=@status, telephone=@phone, residence=@residence, profession=@job, department=@department WHERE id=@id;"
            DeleteCommand="DELETE FROM [memberTable] WHERE [id]=@id">             
               
            <UpdateParameters>                 
                 <asp:controlparameter Name="firstname" controlid="fname" />
                 <asp:controlparameter Name="surname" controlid="sname"/>
                 <asp:controlparameter Name="gender" controlid="sex" Type="String"/>
                 <asp:controlparameter Name="dob" controlid="dob"/>
                <asp:controlparameter Name="marital_status" controlid="status"/>
                 <asp:controlparameter Name="telephone" controlid="phone"/>                 
                 <asp:controlparameter Name="residence" controlid="residence"/>
                 <asp:controlparameter Name="department" controlid="department"/>
                <asp:controlparameter Name="profession" controlid="job"/>
             </UpdateParameters>
 ...
 <asp:GridView ID="gvMember" runat="server"  DataSourceID="dsMember" AutoGenerateColumns="false" CssClass="table table-striped" DataKeyNames="id">
